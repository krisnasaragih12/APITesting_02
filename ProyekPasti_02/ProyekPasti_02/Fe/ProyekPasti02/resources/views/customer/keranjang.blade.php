...
<!-- Notifikasi Cart Menu End -->
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-90 bg-image" data-bs-bg="images/background.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                    <div class="ltn__checkout-payment-method mt-50">
                        ...
                        <div id="checkout_accordion_1">
                            <!-- card -->
                            <div class="card">
                                <input type="radio" name="payment_method" id="bayar-di-tempat" data-bs-toggle="collapse" data-bs-target="#faq-item-2-1" aria-expanded="false" style="position: absolute; top: 13px; left: 7px;"><label class="ltn__card" for="bayar-di-tempat">E-Money</label>
                            ...
                            <div class="card">
                                <input type="radio" name="payment_method" id="via-bank" data-bs-toggle="collapse" data-bs-target="#faq-item-2-3" aria-expanded="false" style="position: absolute; top: 13px; left: 7px;"><label class="" for="via-bank">Via Bank</label>
