...
<div class="body-wrapper">
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-90 bg-image" data-bs-bg="app-assets/images/register/1.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
