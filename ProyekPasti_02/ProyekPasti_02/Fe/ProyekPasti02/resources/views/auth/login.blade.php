            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        <h1 class="section-title">Masuk <br>Ke akun kamu</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="account-login-inner">
                        <form action="{{ url('login') }}" class="ltn__form-box contact-form-box" method="POST">
                            @csrf
                            <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" placeholder="Email*" value="{{ old('username') }}" autocomplete="off">
                            <input class = "form-control @error('password') is-invalid @enderror" type="password" name="password" placeholder="Password*" value="{{ old('username') }}" autocomplete="off">
                ...
                <div class="col-lg-6">
                    <div class="account-create text-center pt-50">
                        ...
                        <div class="btn-wrapper">
                            <a href="{{ url('register') }}" class="theme-btn-1 btn black-btn">Daftar</a>
                        </div>
                    </div>
                </div>
            </div>
